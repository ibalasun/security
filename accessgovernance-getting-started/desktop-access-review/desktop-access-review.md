...
2. You will see access review tasks for LiveLab user for DB-Manage-Access. Click on view to review the insights of the review tasks.
...
3. Under Actions, click on Accept to the request for the users Livelab user. 
